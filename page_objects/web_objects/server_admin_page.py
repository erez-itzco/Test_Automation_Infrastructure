...
users_list = (By.XPATH, "//tbody/tr/td[1]")
user_by_user_name = (By.CSS_SELECTOR, "a[title='nunu']")
...
class ServerAdminPage():
    ...
    def get_user_by_user_name(self, user):
        return self.driver.find_element(user_by_user_name[0], user_by_user_name[1].replace('nunu', str(user)))
